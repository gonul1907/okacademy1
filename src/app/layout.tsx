  ...
  return (
    <html lang="nl" className={inter.variable}>
      ...
      <body className="antialiased bg-white text-gray-900">
        ...
        <a
          href="https://wa.me/31640727145"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Stuur een WhatsApp bericht"
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:bg-[#1ebe5d] transition-colors duration-200"
        >
